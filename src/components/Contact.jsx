      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Interested in working together? Feel free to reach out to me for collaborations or just a friendly hello!
          </p>
        </div>
          ...
          <div className="lg:w-7/12">
            <div className="bg-white rounded-xl shadow-md p-8">
              ...
              <form>
                ...
                <button
                  type="submit"
                  className="w-full bg-blue-600 text-white py-3 px-6 rounded-lg hover:bg-blue-700 transition shadow-md"
                >
                  Send Message
                </button>
              </form>
            ...
            <div className="bg-white rounded-xl shadow-md p-8 h-full">
              ...
              <div className="mt-10">
                ...
                <div className="flex space-x-4">
                  <a href="#" className="bg-gray-100 hover:bg-blue-100 p-3 rounded-full transition">
